    ...
    >
      ...
      >
        ...
        <div className="px-3 md:px-2.5 py-2 md:py-1.5 space-y-1 md:space-y-0.5 shrink-0 text-sm md:text-[13px]">
          ...
          {/* PLUGINS MENU ITEM — normal/static, no arcade games */}
          <div
            className="flex items-center gap-3 md:gap-2.5 text-[#ececf1] hover:bg-[#1a1a1a] py-2.5 md:py-1.5 px-3 md:px-2.5 rounded-xl md:rounded-lg cursor-default transition-colors"
          >
            <ToyBrick size={17} className="text-[#9b9b9b]" />
            <span>Plugins</span>
          </div>
